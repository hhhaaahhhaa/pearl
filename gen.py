...
for k, v in dataset.items():
    ...
    for data_item in tqdm(v): 
        ...
        prompts = [f"Instruct: {i} For the Question: {q}\nOutput:" for i in actions_str]

        # Perform batch processing
        inputs = tokenizer.batch_encode_plus(prompts, return_tensors="pt", return_attention_mask=True, padding=True, truncation=True)
        ...
        for i, text in zip(actions_str, texts):
